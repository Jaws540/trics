...
import characterModel.scripts.compiler.Interpreter;
import characterModel.scripts.compiler.Token;
...
public class AppTest {
	...
	private final String characterSavePath = "test/testSave1.json";
    ...
    @Test public void testCharacterSaveToJson() {
    	boolean output = CharacterIO.saveCharacter(TestData.getTestCharacter(), characterSavePath);
    	assertTrue(output);
    }
